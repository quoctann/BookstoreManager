...
# def get_wish_detail_by_current_user(current_user_id): return WishDetail.query.join(WishDetail, Wish.wish_id ==
# WishDetail.wish_id).filer(Wish.customer_id.contains(current_user_id)).add_columns(Wish.wish_id).all()
